...
class IndeedJobSpider(scrapy.Spider):
    ...
    def get_indeed_search_url(self, keyword, location, offset=0):
        ...
        return "https://fr.indeed.com/jobs?" + urlencode(parameters)


    def start_requests(self):
        keyword_list = ['software engineer','data scientist','data engineer', 'data analyst','stage data']
        location_list = ['paris','nantes','rouen']
